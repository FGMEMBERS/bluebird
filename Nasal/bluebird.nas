# ===== Bluebird Explorer Hovercraft  version 6.0 for FlightGear v1.0 (PLIB and OSG) =====
...
# interior lighting and emissions -----------------------------------
	# surface# color/location SEE LINE# 1529 for location of calculations
	#  0       Overhead lights
	#  1       Blue        Rug/Floor
...
var panel_lighting_update = func {
	...
	if (reactor_request) {	# power subsystem on = 2green
		button_LT2 = 2;
	} else {
...
#                 === initial calls at startup ===
 ...
 print ("  version 6.0  release date 2008.Feb.23  for FlightGear 1.0");
});
