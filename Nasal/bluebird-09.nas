# ===== Bluebird Explorer Hover Flyer  version 5.0 for FlightGear v0.9.10  =====
...
# surface# color/location SEE LINE# 986 for location of calculations
#  0       Overhead lights
#  1       Blue        Rug/Floor
...
var interior_lighting_update = func {
  ...
  setprop("sim/model/bluebird/lighting/emission/I4-red", 0.0600 * intli);
  ...
  setprop("sim/model/bluebird/lighting/emission/IA-red", 0.0500 * intli);
  setprop("sim/model/bluebird/lighting/emission/IU-red", 0.0700 * intli);
  ...
  setprop("sim/model/bluebird/lighting/emission/I4-green", 0.0600 * intlir);
  setprop("sim/model/bluebird/lighting/emission/I4-blue", 0.0600 * intlir);
  ...
  setprop("sim/model/bluebird/lighting/emission/IA-green", 0.0700 * intlir);
  setprop("sim/model/bluebird/lighting/emission/IA-blue", 0.0900 * intlir);
  setprop("sim/model/bluebird/lighting/emission/IU-green", 0.0690 * intlir);
  setprop("sim/model/bluebird/lighting/emission/IU-blue", 0.0550 * intlir);
...
#                 === initial calls at startup ===
 ...
 print ("  version 5.0  release date 2008.Jan.19 for FlightGear 0.9.10");
